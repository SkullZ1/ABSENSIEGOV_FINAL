      ...
      <div class="modal-body">
        <form action="/action/edit/<?php echo e($dt->id); ?>" method="POST">
          ...
          <div class="mb-3">
            ...
            <input id="name" type="text" class="form-control" name="edit_name" value="<?php echo e($dt->name); ?>" placeholder=" " autofocus>
          </div>
          <div class="mb-3">
            <label for="email" class="col-form-label">Email</label>
            <input id="email" type="text" class="form-control" name="edit_email" value="<?php echo e($dt->email); ?>"  autofocus>
          </div>
          <div class="mb-3">
            <label for="eemail" class="col-form-label">NIP</label>
            <input id="eemail" type="text" class="form-control" name="edit_eemail" value="<?php echo e($dt->eemail); ?>" autofocus maxlength="18">
          </div>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Magang\ProjekAbsenEgov\AbsensiEGOV\resources\views/datakaryawan.blade.php ENDPATH**/ ?>