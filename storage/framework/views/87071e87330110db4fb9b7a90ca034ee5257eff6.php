...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <!-- icon title -->
    <link rel="icon" href="<?php echo e(asset('egov/img/logojateng.svg.png')); ?>" type="image/icon type">
    <!--<title> Drop Down Sidebar Menu | CodingLab </title>-->
    <title><?php echo $__env->yieldContent('title'); ?></title>
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('egov/style/sidebar.css')); ?>">
...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      <img src="<?php echo e(asset('egov/img/logojateng.svg.png')); ?>" alt="" width="30" height="30" style="margin-left:25px">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="<?php echo e(route('admin')); ?>">Jam Kerja</a></a></li>
    ...
    <div class="profile-details">
      ...
      <div class="image"><img src="<?php echo e(asset('egov/img/avatar.png')); ?>" alt="Avatar" class="avatar"></div>
      <div class="name-job">
...
<?php /**PATH D:\Magang\ProjekAbsenEgov\ABSENEGOV_FINAL\resources\views/header.blade.php ENDPATH**/ ?>