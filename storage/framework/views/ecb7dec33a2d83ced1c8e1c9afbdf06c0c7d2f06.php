...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <?php if(date('G:i:s') > $jam->jam_mulai && date('G:i:s') < $jam->jam_selesai): ?>
            <?php if($today == NULL): ?>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Magang\ProjekAbsenEgov\ABSENEGOV_FINAL\resources\views/absensi.blade.php ENDPATH**/ ?>